...
public class Action {
	...
	Rogue rogue;
		...
		public Action(Score score, Clock clock, Position position) {
			this(score, clock, Rogue.pseudoRandomApproach(score.getAct(), score.getPlan(), score.getCrew(), score.getBeats()), position, randomEffect());
		}
		...
		public String toStringDetailed() {
			...
			string = String.format("%s attempts %s %s check %n   (%d dice) achieves %s", rogue.toString(), position, approach, dice, checkResult);
